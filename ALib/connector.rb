...
module Attrition
  class Connector
    ...
    USER_AGENT = "AttritionClient"
# USER_AGENT = 'AttritionClient/%s (%s; +%s)' % [
#     Attrition::Client::Version::VERSION,
#     RUBY_DESCRIPTION,
#     'https://baremetalnetworks.com'
# ]
METHODS = {
    :head   => Net::HTTP::Head,
    :get    => Net::HTTP::Get,
...
DEFAULT_HOST = 'sw.baremetalneworks.com'
HOST = Attrition.config() || DEFAULT_HOST
PORT = 443
...
def put path, body = nil, options = {}
  request :put, pathttps://munin.readthedocs.org/en/latest/example/rrdcached/upstart.htmlh, options.merge(:body => body)
end
