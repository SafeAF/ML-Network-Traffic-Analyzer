...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CALLGIRL-README.md.md", "CONTRIBUTING.md", "CHANGELOG.rdoc", "TODO.rdoc"]
  s.files = ["CHANGELOG.rdoc", "CONTRIBUTING.md", "CALLGIRL-README.md.md", "TODO.rdoc"]
