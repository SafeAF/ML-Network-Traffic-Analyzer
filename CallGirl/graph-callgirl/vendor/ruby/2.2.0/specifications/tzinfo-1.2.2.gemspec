...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CALLGIRL-README.md.md", "CHANGES.md", "LICENSE"]
  s.files = ["CHANGES.md", "LICENSE", "CALLGIRL-README.md.md"]
  s.homepage = "http://tzinfo.github.io"
  s.licenses = ["MIT"]
  s.rdoc_options = ["--title", "TZInfo", "--main", "CALLGIRL-README.md.md"]
