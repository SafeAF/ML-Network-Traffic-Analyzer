Gem::Specification.new do |s|
  ...
  s.license = 'MIT' 
  s.files = %w(CHANGES.md LICENSE Rakefile CALLGIRL-README.md tzinfo.gemspec .yardopts) +
  ...
  s.rdoc_options << '--title' << 'TZInfo' << 
                    '--main' << 'CALLGIRL-README.md'
  s.extra_rdoc_files = ['CALLGIRL-README.md', 'CHANGES.md', 'LICENSE']
