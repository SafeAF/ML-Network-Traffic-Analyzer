class DatabasesController < ApplicationController
  ...
  private
    ...
    def database_params
      params.require(:database).permit(:name, :hostname, :cluster, :type, :dbserver, :db, :count, :user, :password, :connection_string, :server_id, :machine_id, :cluster_id, :service_id, :application_id, :infrastructure_id, :status, :purpose, :criticality, :priority, :network_id, :devops_id)
    end
end
