...
class TasklistsControllerTest < ActionController::TestCase
  ...
  test "should create tasklist" do
    assert_difference('Tasklist.count') do
      post :create, tasklist: { desc: @tasklist.desc, name: @tasklist.name, project_id: @tasklist.project_id, total_tasks: @tasklist.total_tasks }
    end
  ...
  test "should update tasklist" do
    patch :update, id: @tasklist, tasklist: { desc: @tasklist.desc, name: @tasklist.name, project_id: @tasklist.project_id, total_tasks: @tasklist.total_tasks }
    assert_redirected_to tasklist_path(assigns(:tasklist))
  end
