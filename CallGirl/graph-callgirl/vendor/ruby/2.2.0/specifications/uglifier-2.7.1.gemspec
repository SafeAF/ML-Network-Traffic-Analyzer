...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["LICENSE.txt", "CALLGIRL-README.md.md", "CHANGELOG.md", "CONTRIBUTING.md"]
  s.files = ["CHANGELOG.md", "CONTRIBUTING.md", "LICENSE.txt", "CALLGIRL-README.md.md"]
