...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CONTRIBUTING.md", "HISTORY.md", "Manifest.txt", "CALLGIRL-README.md"]
  s.files = ["CONTRIBUTING.md", "HISTORY.md", "Manifest.txt", "CALLGIRL-README.md", "ext/hitimes/c/extconf.rb"]
  s.homepage = "http://github.com/copiousfreetime/hitimes"
  s.licenses = ["ISC"]
  s.rdoc_options = ["--main", "CALLGIRL-README.md", "--markup", "tomdoc"]
