...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG.md", "CONTRIBUTING.md", "CALLGIRL-README.md.md", "GUIDE.md"]
  s.files = ["CHANGELOG.md", "CONTRIBUTING.md", "GUIDE.md", "CALLGIRL-README.md.md", "bin/byebug", "ext/byebug/extconf.rb"]
